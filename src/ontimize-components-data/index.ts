...
export { OIntegerInputData } from './input/o-integer-input.data';
export { ONifInputData } from './input/o-nif-input.data';
export { OPasswordInputData } from './input/o-password-input.data';
export { OPercentInputData } from './input/o-percent-input.data';
export { ORealInputData } from './input/o-real-input.data';
